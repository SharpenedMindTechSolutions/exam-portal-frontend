...
//               <input name="title" value={examMeta.title} onChange={handleMetaChange} placeholder="Title" className="border rounded px-3 py-2" />
//               <input name="domain" value={examMeta.domain} onChange={handleMetaChange} placeholder="Domain" className="border rounded px-3 py-2" />
//               <input name="duration" value={examMeta.duration} onChange={handleMetaChange} placeholder="Duration (min)" className="border rounded px-3 py-2" />
//               <input name="passingScore" value={examMeta.passingScore} onChange={handleMetaChange} placeholder="Passing score" className="border rounded px-3 py-2" />
//               <textarea name="description" value={examMeta.description} onChange={handleMetaChange} placeholder="Description" className="col-span-1 md:col-span-2 border rounded px-3 py-2" />
//             </div>
//           </div>
...
//             <div className="mb-3">
//               <input value={form.question} onChange={(e) => handleFormChange("question", e.target.value)} placeholder="Question text" className="w-full border rounded px-3 py-2" />
//             </div>
//             <div className="mb-3 space-y-2">
//               {form.options.map((opt, i) => (
//                 <div key={i} className="flex items-center gap-2">
//                   <label className="flex items-center gap-2">
//                     <input type="radio" name="correct" checked={form.correctAnswer === i} onChange={() => setCorrect(i)} className="text-blue-600" />
//                   </label>
//                   <input value={opt} onChange={(e) => handleOptionChange(i, e.target.value)} placeholder={`Option ${i + 1}`} className="flex-1 border rounded px-3 py-2" />
...
//                       className="px-2 py-1 bg-blue-600 text-white rounded-md flex items-center gap-1 text-sm hover:bg-blue-700 transition"
//                     >
//                       <Edit size={16} /> Edit
//                     </button>
//                     <button
//                       onClick={() => deleteQuestion(idx)}
//                       className="px-2 py-1 bg-red-600 text-white rounded-md flex items-center gap-1 text-sm hover:bg-red-700 transition"
//                     >
...
//                 className="px-3 py-2 border rounded-md flex items-center gap-1 hover:bg-gray-100 transition"
//               >
...
//                             <button
//                               onClick={() => loadExam(exam, false)}
//                               className="px-2 py-1 bg-blue-600 text-white rounded-md flex items-center gap-1 text-sm hover:bg-blue-700"
//                             >
//                               <Edit size={14} /> Preview
//                             </button>
//                             <button
//                               onClick={() => loadExam(exam, true)}
//                               className="px-2 py-1 bg-green-600 text-white rounded-md flex items-center gap-1 text-sm hover:bg-green-700"
//                             >
//                               <Edit size={14} /> Edit
//                             </button>
//                             <button
//                               onClick={() => deleteExistingExam(exam._id)}
//                               className="px-2 py-1 bg-red-600 text-white rounded-md flex items-center gap-1 text-sm hover:bg-red-700"
//                             >
